...
const MCQsClient = () => {
    ...
    const pdfUrl = "/Unit10.pdf";
    const classLabel = "Class 11";
    const subject = "Mathematics";
    const unitLabel = "Unit 10";
    const unitTitle = "Trigonometric Identities";
    ...
    const relatedUnits = [
        { label: "Unit 1 – Complex Numbers", href: "/mcqs/class-11-mcqs-unit-1", active: false },
        ...
        { label: "Unit 10 – Trigonometric Identities", href: "/mcqs/class-11-mcqs-unit-10", active: true },
    ];
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                    <div className="text-center space-y-8">
                        ...
                        <p className="text-gray-600 text-xl max-w-3xl mx-auto leading-relaxed">
                            Download <strong>free MCQs for {classLabel} {subject} {unitLabel} – {unitTitle}</strong> as per{' '}
                            <strong>{boardName}</strong> curriculum. Perfectly crafted for FSc Part 1 exam preparation with
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 text-lg">
                            All key concepts of Trigonometric Identities tested in Punjab Board MCQs
                        </p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {[
                            ...
                            "Allied Angles (Cofunction Identities)",
                            ...
                            <div
                                key={i}
                                className="flex items-center gap-3 bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-100 rounded-xl px-5 py-4"
                            >
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="flex-1">
                            <div className="text-center mb-10">
                                ...
                                <p className="text-gray-600 text-lg">
                                    View all {unitTitle} MCQs online before downloading
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-center sm:text-left">
                                            ...
                                            <p className="text-cyan-100 text-sm">
                                                {unitTitle} · {boardName} · Academic Year {academicYear} · With Answer Key
                                            </p>
                                        </div>
                                    </div>
                                    <button
                                ...
                                <div className="relative bg-gray-50" style={{ height: '800px' }}>
                                    <iframe
                                        ...
                                        title={`${classLabel} ${subject} ${unitLabel} – ${unitTitle} MCQs PDF – ${boardName} ${academicYear}`}
                                        style={{ border: 'none' }}
                                    />
                                    {/* Fallback */}
                                    <noscript>
                        ...
                        <div className="lg:w-80 shrink-0">
                            <div className="sticky top-8">
                                ...
                                <div className="mt-6 bg-amber-50 border border-amber-200 rounded-2xl p-5">
                                    <h4 className="font-bold text-amber-800 mb-2 text-base flex items-center gap-2">
                                        <Sparkles size={16} />
                                        Exam Tip
                                    </h4>
                                    <p className="text-amber-700 text-sm">
                                        Trigonometric Identities (Unit 10) carries high weightage in Punjab Board FSc Part 1 exams. Focus on double angle and half angle formulas for MCQs.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                        Why Use Our {unitTitle} MCQs?
                    </h2>
                    <p className="text-gray-600 text-lg mb-12 max-w-2xl mx-auto">
                        Carefully prepared by subject experts following the exact {boardName} pattern for FSc Part 1.
                    </p>
                        ...
                        {[
                            {
                                ...
                                title: "Board-Focused",
                                desc: "Every MCQ is designed to match the exact pattern and difficulty of Punjab Board FSc Part 1 exams for Unit 10."
                            },
                            {
                            ...
                            },
                            {
                                ...
                                desc: "No signup, no paywall. Just click download and get your Trigonometric Identities MCQs instantly."
                            },
                        ].map((item, i) => (
            ...
            <section className="py-20 bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-xl text-cyan-100 mb-10">
                        Download free {unitTitle} MCQs for {classLabel} {subject} and ace your {boardName} FSc Part 1 exam
                    </p>
            ...
            <section className="py-12 bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-gray-500">
                        {classLabel} {subject} MCQs based on {boardName} curriculum · {unitLabel} – {unitTitle} · FSc Part 1 {academicYear}
                    </p>
                </div>
            </section>
        </div>
