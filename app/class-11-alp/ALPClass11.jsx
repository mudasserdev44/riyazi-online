...
const ALPClient = () => {
    const pdfUrl = "/class-11-smart-syllabus-2025-2026.pdf"; // Updated PDF URL
            ...
            <nav className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <ChevronRight size={16} className="text-gray-400" />
                        <span className="text-gray-900 font-semibold">Class 11 (2025-2026)</span>
                    </div>
                </div>
            </nav>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                    <div className="text-center space-y-8">
                        ...
                        <p className="text-gray-600 text-xl max-w-3xl mx-auto leading-relaxed">
                            Complete smart syllabus for <strong>Class 11 all subjects</strong> as per <strong>Punjab Board</strong> curriculum.
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                        <div className="bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-center sm:text-left">
                                    <h3 className="text-white font-bold text-xl">Class 11 Smart Syllabus</h3>
                        ...
                        <div className="relative bg-gray-50" style={{ height: '800px' }}>
                            <iframe
                                ...
                                title="Class 11 Smart Syllabus 2025-2026 PDF"
                                style={{ border: 'none' }}
                            />
            ...
            <section className="py-12 bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-gray-500">
                        Smart Syllabus based on Punjab Board curriculum for Class 11 - All Subjects
                    </p>
                </div>
            </section>
        </div>
